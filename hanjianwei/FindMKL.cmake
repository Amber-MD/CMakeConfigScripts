...
if(MKL_SDL)
   ...
   ############################ Link Options ##########################
    ...
    set(MKL_LIBRARIES ${LIB_LIST_PREFIX} ${MKL_CORE_LIBRARY} 
    	${${MKL_THREADING_LIBRARY}} ${MKL_INTERFACE_LIBRARY} ${LIB_LIST_SUFFIX} ${MKL_LIBDL} ${MKL_PTHREAD_LIB})
    set(MKL_FORTRAN_LIBRARIES ${LIB_LIST_PREFIX} ${MKL_CORE_LIBRARY} 
    ...
    if(DEFINED "${MKL_OMP_LIBRARY}")
    	if(NOT "${MKL_OMP_LIBRARY}" STREQUAL "" AND NOT "${${MKL_OMP_LIBRARY}}" STREQUAL "")
    		list(APPEND MKL_NEEDED_LIBNAMES ${MKL_OMP_LIBRARY})
    		list(APPEND MKL_LIBRARIES ${${MKL_OMP_LIBRARY}})
    		list(APPEND MKL_FORTRAN_LIBRARIES ${${MKL_OMP_LIBRARY}})
    	endif()
	endif()
endif()
