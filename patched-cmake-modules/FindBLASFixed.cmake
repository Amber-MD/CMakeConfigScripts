...
# AMBER: MKL support has been removed from this file so that it doesn't conflict with FindMKL
#  We also provide this to allow OpenBLAS to be used with older CMake versions
	...
	if(_libraries_work)
		...
		if (CMAKE_Fortran_COMPILER_LOADED)
			...
			if(NOT ${_prefix}${_combined_name}_WORKS)
				check_function_exists("${_name}" ${_prefix}${_combined_name}_WORKS_NOUNDERSCORE)
				if(${_prefix}${_combined_name}_WORKS_NOUNDERSCORE)
					set(${_prefix}${_combined_name}_WORKS TRUE CACHE BOOL "" FORCE)
				endif()
			endif()
		endif()
...
if (BLA_VENDOR MATCHES "ACML" OR BLA_VENDOR STREQUAL "All")
 if( ((BLA_VENDOR STREQUAL "ACML") AND (NOT BLAS_ACML_LIB_DIRS)) OR
	 ...
	 if(NOT "${_ACML_GPU_ROOT}" STREQUAL "")
